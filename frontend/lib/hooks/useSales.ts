...
export function useSales(params?: PaginationParams & { status?: string; startDate?: string; endDate?: string; search?: string; platform?: string; paymentMethod?: string }, options?: { enabled?: boolean }) {
  return useQuery({
