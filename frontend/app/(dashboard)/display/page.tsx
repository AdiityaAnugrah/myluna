...
export default function DisplaySystemPage() {
  ...
  return <div className="space-y-6">
    <style jsx global>{`@page { size: A4; margin: 12mm; } @media print { body * { visibility: hidden; } #display-letter, #display-letter *, #display-request-preview, #display-request-preview * { visibility: visible; } #display-letter, #display-request-preview { position: absolute; left: 0; top: 0; width: 210mm !important; min-height: 297mm !important; box-shadow: none !important; border: none !important; border-radius: 0 !important; } .no-print { display: none !important; } }`}</style>
