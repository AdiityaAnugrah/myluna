...
import { PackageOpen, Plus, RefreshCcw, Send, Check, X } from 'lucide-react';
...
export default function DisplaySystemPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold flex items-center gap-2"><PackageOpen className="h-8 w-8" /> Sistem Display</h1>
        <p className="text-muted-foreground mt-1">Manajemen produk display terpisah dari penjualan, stok operasional, dan keuangan.</p>
      </div>
      ...
      <Tabs defaultValue="products" className="space-y-4">
        <TabsList className="flex flex-wrap h-auto justify-start">
          <TabsTrigger value="products">Produk Display</TabsTrigger>
          <TabsTrigger value="stock">Stok Display</TabsTrigger>
          <TabsTrigger value="requests">Pengajuan</TabsTrigger>
          <TabsTrigger value="categories">Kategori</TabsTrigger>
          <TabsTrigger value="suppliers">Supplier</TabsTrigger>
          <TabsTrigger value="movements">Riwayat Stok</TabsTrigger>
        </TabsList>
          ...
          {isAdmin && (
            <Card>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <Button onClick={addProduct} disabled={!productForm.sku || !productForm.name || createProduct.isPending}><Plus className="h-4 w-4 mr-2" /> Tambah</Button>
              </CardContent>
            </Card>
          )}
          <Card>
        ...
        <TabsContent value="requests" className="space-y-4">
          <Card><CardHeader><CardTitle>Buat Pengajuan Stok Display</CardTitle></CardHeader><CardContent className="grid grid-cols-1 md:grid-cols-5 gap-3">
