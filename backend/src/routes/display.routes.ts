...
router.post('/requests/review-bulk', rbac(['ADMIN', 'SUPER_ADMIN']), displayController.reviewRequestsBulk);
...
router.post('/returns/:id/status', rbac(['ADMIN', 'SUPER_ADMIN']), displayController.updateReturnStatus);
